                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" id="jurusan" name="jurusan">
                                    ...
                                    <option value="Teknik Informatika" <?php if ($data_mahasiswa->jurusan == "Teknik Informatika") : echo "selected";
                                                                        endif; ?>>Teknik Informatika</option>
                                    <option value="Sistem Informasi" <?php if ($data_mahasiswa->jurusan == "Sistem Informasi") : echo "selected";
                                                                        endif; ?>>Sistem Informasi</option>
                                    <option value="Teknik Komputer" <?php if ($data_mahasiswa->jurusan == "Teknik Komputer") : echo "selected";
                                                                    endif; ?>>Teknik Komputer</option>
                                    <option value="Manajemen Informatika" <?php if ($data_mahasiswa->jurusan == "Manajemen Informatika") : echo "selected";
                                                                            endif; ?>>Manajemen Informatika</option>
                                    <option value="Komputerisasi Akuntansi" <?php if ($data_mahasiswa->jurusan == "Komputerisasi Akuntansi") : echo "selected";
                                                                            endif; ?>>Komputerisasi Akuntansi</option>
                                    <option value="Teknik Elektro" <?php if ($data_mahasiswa->jurusan == "Teknik Elektro") : echo "selected";
